...
export async function AuthBrandingPane(): Promise<React.JSX.Element> {
  ...
  const features = [
    ...
    {
      icon: Zap,
      title: t("features.timezone.title"),
      description: t("features.timezone.description"),
    },
    {
      icon: ShieldCheck,
  ...
  return (
    <div className="hidden lg:flex lg:col-span-5 flex-col justify-between p-12 bg-secondary/10 border-e border-border/40 relative z-10">
      ...
      <Link
        href="/"
        className="flex items-center gap-2.5 font-bold text-xl tracking-tight text-foreground select-none w-fit"
      >
