    ...
    <div className="lg:col-span-7 flex flex-col space-y-6 text-start">
      ...
      <div className="flex flex-col sm:flex-row gap-4 pt-4">
        <SignUpButton mode="modal">
          <Button
            size="lg"
            className="h-12 px-6 text-base font-semibold shadow-xl shadow-primary/25 group bg-primary text-primary-foreground hover:bg-primary/90"
          >
            {tc("getStartedFree")}
            <ArrowRight
              aria-hidden="true"
              className="ms-2 size-4 transition-transform group-hover:translate-x-1 rtl:group-hover:-translate-x-1 rtl:rotate-180"
            />
          </Button>
        </SignUpButton>
        <SignInButton mode="modal">
          <Button
            size="lg"
            variant="outline"
            className="h-12 px-6 text-base font-medium glass-card hover:bg-secondary/50"
          >
            {tc("bookAnEvent")}
          </Button>
        </SignInButton>
