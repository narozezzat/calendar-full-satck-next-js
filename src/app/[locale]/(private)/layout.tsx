  ...
  return (
    <div className="flex flex-col flex-1 min-h-0">
        ...
        <header className="w-full border-b border-border/40 bg-background/85 backdrop-blur-xl">
          <div className="container flex items-center justify-between gap-3 sm:gap-4 h-14 sm:h-16">
            ...
            >
              <LogoIcon
                size={40}
                className="size-8 sm:size-10 transition-all group-hover:shadow-primary/30 group-hover:border-primary/40"
              />
      ...
      <main className="flex-1 overflow-y-auto overflow-x-hidden relative z-10">
        <div className="container py-6 sm:py-8 animate-fade-in">{children}</div>
      </main>
    </div>
  );
}
